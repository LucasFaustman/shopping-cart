# Lucas Faustman Boutique - React Ecommerce Site

Browse favourite products on Lucas Faustman Boutique! Add items to your cart and checkout!

Link to project: https://lucas-faustman-boutique.netlify.app/
...
I was able to get the opportunity to go deeper on React Redux and persist in order to save products to a global state cart.

## Optimizations

- I would further optimize for mobile users

- Add a Stripe test checkout page

- Add products from a customized local JSON file or database rather than using an API. 
